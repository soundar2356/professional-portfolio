...
const Data = () => {
  return (
   <div className="home__data">
    <h1 className="home__title">Soundra Pandi
    <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
    ...
    <h3 className="home__subtitle">Aspiring Full Stack Engineer</h3>
    <p className="home__discription">currently gaining expertise in Full Stack development and Passionate about solving <br/>real-world problems and grow as a professional in the software development field 
    </p>
